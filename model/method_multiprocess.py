...
def SIFRank(text, SIF, en_model, method="average", N=15,
            sent_emb_method="elmo", elmo_layers_weight=[0.0, 1.0, 0.0], if_DS=True, if_EA=True, kwdict=None, cut_dict=False):
    """
    :param text_obj:
    ...
    :return:
    """
    text_obj = input_representation.InputTextObj(en_model, text, kwdict, cut_dict=cut_dict)
...
def SIFRank_plus(text, SIF, text_obj, method="average", N=15,
            sent_emb_method="elmo", elmo_layers_weight=[0.0, 1.0, 0.0], if_DS=True, if_EA=True, position_bias = 3.4, kwdict=None, cut_dict=False):
    """
    :param text_obj:
    :param sent_embeddings:
    :param candidate_embeddings_list:
    ...
    :return:
    """
    # text_obj = input_representation.InputTextObj(en_model, text, kwdict, cut_dict)
    # text_obj = text_worker(text)
    sent_embeddings, candidate_embeddings_list = SIF.get_tokenized_sent_embeddings(text_obj,if_DS=if_DS,if_EA=if_EA)
